...
VALUES ('Men''s', 'Men''s teams competing two-on-two');

INSERT INTO core.category (name, description)
VALUES ('Women''s', 'Women''s teams competing two-on-two');

INSERT INTO core.category (name, description)
VALUES ('Mixed', 'Mixed teams competing two-on-two');

INSERT INTO core.category (name, description)
VALUES ('Open', 'Open teams competing two-on-two');
...
INSERT INTO core.format (name, description, category, max_participants, min_participants, rules)
VALUES ('Double Elimination', 'Teams must lose twice to be eliminated. Provides a second chance for early losers.', 'Elimination', 32, 4, 
...
INSERT INTO core.format (name, description, category, max_participants, min_participants, rules)
VALUES ('Round Robin', 'All teams compete against each other. Team with the best record wins.', 'Round Robin', 16, 3,
...
INSERT INTO core.format (name, description, category, max_participants, min_participants, rules)
VALUES ('Swiss System', 'Players are paired based on similar scores. Efficient for large tournaments.', 'Swiss', 128, 8, 
...
INSERT INTO core.registration_type (name, description)
VALUES ('Team', 'Players register as a team.');

INSERT INTO core.registration_type (name, description)
VALUES ('Individual or Team', 'Players register individually or as a team. Individual players will be assigned to a team by the tournament organiser.');
...
INSERT INTO core.tournament_status (name, description, color, text_color)
VALUES ('Registration Open', 'Players can register for the tournament.', '#4ade80', '#374151');

INSERT INTO core.tournament_status (name, description, color, text_color)
VALUES ('Registration Closed', 'Registration period has ended, preparing for tournament.', '#eab308', '#374151');

INSERT INTO core.tournament_status (name, description, color, text_color)
VALUES ('In Progress', 'Tournament is currently being played.', '#2563eb', '#ffffff');

INSERT INTO core.tournament_status (name, description, color, text_color)
VALUES ('Completed', 'Tournament has been completed.', '#9333ea', '#ffffff');

INSERT INTO core.tournament_status (name, description, color, text_color)
VALUES ('Cancelled', 'Tournament has been cancelled.', '#ef4444', '#ffffff');
...
INSERT INTO core.venue_type (name, description)
VALUES ('Multiple Venues', 'Tournament will be at multiple venues.');
...
INSERT INTO core.advancement_model (name, description)
VALUES ('Elimination only', 'Only the top team progresses to the next round.');

-- Elimination Bracket Size
INSERT INTO core.elimination_bracket_size (name, description, teams)
VALUES ('Final', '2 teams advance to final', 2);

INSERT INTO core.elimination_bracket_size (name, description, teams)
VALUES ('Semi-finals', '4 teams advance to semi-finals', 4);

INSERT INTO core.elimination_bracket_size (name, description, teams)
VALUES ('Quarter-finals', '8 teams advance to quarter-finals', 8);
...
INSERT INTO core.teams_to_advance (name, description, team_count)
VALUES ('4', '4 teams per group.', 4);

INSERT INTO core.teams_to_advance (name, description, team_count)
VALUES ('2', '2 teams per group.', 2);

INSERT INTO core.teams_to_advance (name, description, team_count)
VALUES ('1', '1 team per group.', 1);
